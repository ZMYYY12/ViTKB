...
def main():
    ...
    parser.add_argument('--weights', type=str, default='./weights/model-8.pth', help='Model weights path')
    ...
    try:
        ...
        # 尝试完全匹配加载
        model = create_model(num_classes=4, has_logits=False).to(device)  # 假设权重是4分类
...
if __name__ == '__main__':
    main()
#单张图片预测
#python predict.py --image-path "D:\vision_transformer\datasets\test\Grey spot\Grey spot_1.jpg"
#整个文件夹的图片预测
